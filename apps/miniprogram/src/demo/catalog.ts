...
export const demoComponents: DemoComponent[] = [
  ...
  { category: "basic", slug: "button-group", title: "Button-Group 按钮组", route: "pages/basic/button-group/index" },
  { category: "basic", slug: "kbd", title: "Kbd 键盘标记", route: "pages/basic/kbd/index" },
  { category: "basic", slug: "separator", title: "Separator 分隔符", route: "pages/basic/separator/index" },
  { category: "view", slug: "aspect-ratio", title: "Aspect-Ratio 宽高比", route: "pages/view/aspect-ratio/index" },
  ...
  { category: "view", slug: "image", title: "Image 图片", route: "pages/view/image/index" },
  { category: "view", slug: "chart", title: "Chart 图表", route: "pages/view/chart/index" },
  { category: "view", slug: "data-list", title: "Data-List 数据列表", route: "pages/view/data-list/index" },
  { category: "view", slug: "data-table", title: "Data-Table 数据表格", route: "pages/view/data-table/index" },
  { category: "view", slug: "empty", title: "Empty 空状态", route: "pages/view/empty/index" },
  ...
  { category: "view", slug: "skeleton", title: "Skeleton 骨架屏", route: "pages/view/skeleton/index" },
  { category: "view", slug: "spinner", title: "Spinner 加载旋转", route: "pages/view/spinner/index" },
  { category: "view", slug: "steps", title: "Steps 步骤条", route: "pages/view/steps/index" },
  { category: "view", slug: "table", title: "Table 表格", route: "pages/view/table/index" },
  ...
  { category: "action", slug: "command", title: "Command 命令面板", route: "pages/action/command/index" },
  { category: "action", slug: "context-menu", title: "Context-Menu 上下文菜单", route: "pages/action/context-menu/index" },
  { category: "action", slug: "dialog", title: "Dialog 对话框", route: "pages/action/dialog/index" },
  { category: "action", slug: "dropdown-menu", title: "Dropdown-Menu 下拉菜单", route: "pages/action/dropdown-menu/index" },
  { category: "action", slug: "fab", title: "Fab 浮动按钮", route: "pages/action/fab/index" },
  { category: "action", slug: "hover-card", title: "Hover-Card 悬浮信息卡", route: "pages/action/hover-card/index" },
  ...
  { category: "action", slug: "popover", title: "Popover 弹出层", route: "pages/action/popover/index" },
  { category: "action", slug: "progress", title: "Progress 进度条", route: "pages/action/progress/index" },
  { category: "action", slug: "sheet", title: "Sheet 抽屉面板", route: "pages/action/sheet/index" },
  ...
  { category: "form", slug: "field", title: "Field 字段", route: "pages/form/field/index" },
  { category: "form", slug: "label", title: "Label 标签", route: "pages/form/label/index" },
  { category: "form", slug: "combobox", title: "Combobox 组合选择", route: "pages/form/combobox/index" },
  { category: "form", slug: "input", title: "Input 输入框", route: "pages/form/input/index" },
  { category: "form", slug: "input-group", title: "Input-Group 输入组合", route: "pages/form/input-group/index" },
  { category: "form", slug: "input-otp", title: "Input-OTP 验证码输入", route: "pages/form/input-otp/index" },
  ...
  { category: "form", slug: "toggle", title: "Toggle 切换按钮", route: "pages/form/toggle/index" },
  { category: "form", slug: "toggle-group", title: "Toggle-Group 切换组", route: "pages/form/toggle-group/index" },
  ...
  { category: "layout", slug: "item", title: "Item 条目", route: "pages/layout/item/index" },
  ...
  { category: "layout", slug: "direction", title: "Direction 方向布局", route: "pages/layout/direction/index" },
  { category: "layout", slug: "resizable", title: "Resizable 静态面板", route: "pages/layout/resizable/index" },
  { category: "layout", slug: "safe-area", title: "Safe-Area 安全区", route: "pages/layout/safe-area/index" },
  { category: "layout", slug: "scroll-area", title: "Scroll-Area 滚动区域", route: "pages/layout/scroll-area/index" },
  { category: "layout", slug: "accordion", title: "Accordion 手风琴", route: "pages/layout/accordion/index" },
  { category: "layout", slug: "collapsible", title: "Collapsible 折叠面板", route: "pages/layout/collapsible/index" },
  { category: "navigation", slug: "breadcrumb", title: "Breadcrumb 面包屑", route: "pages/navigation/breadcrumb/index" },
