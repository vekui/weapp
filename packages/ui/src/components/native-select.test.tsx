...
describe("NativeSelect", () => {
  ...
  it("reflects placeholder, disabled, invalid, and tokenized trigger state", () => {
    ...
    expect(getClassName(NativeSelectTrigger({ disabled: true, invalid: true }))).toContain("bg-muted")
    expect(NativeSelectTrigger({ disabled: true }).props["data-disabled"]).toBe("true")
