...
export const controlButtonVariants = cva(
  "inline-flex min-h-[88rpx] items-center justify-center rounded-md px-4 py-2 text-base font-medium transition-colors data-[disabled=true]:opacity-70 data-[loading=true]:opacity-90",
  {
    variants: {
      variant: {
